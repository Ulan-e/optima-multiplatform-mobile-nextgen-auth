...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
	...
	private static final int MAX_YEAR = 3060;
	...
	/**
 	 ...
 	 */
		public void setDateRange(int startYear, int startMonth, int startDay, int endYear, int endMonth, int endDay) {
			...
			if ((startMonth >= 12 || startMonth < 0)) 			throw new IllegalArgumentException("startMonth must be between 0-11");
			if ((endMonth >= 12 || endMonth < 0)) 			throw new IllegalArgumentException("endMonth must be between 0-11");
