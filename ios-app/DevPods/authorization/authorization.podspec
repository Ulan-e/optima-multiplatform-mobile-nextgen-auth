...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Uzumaki/authorization'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Uzumaki' => '123kanatai@gmail.com' }
  s.source           = { :git => 'https://github.com/Uzumaki/authorization.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '14.1'

  #s.source_files = 'authorization/Classes/**/*'
  s.source_files = 'authorization/Features/**/*'
  # s.resource_bundles = {
